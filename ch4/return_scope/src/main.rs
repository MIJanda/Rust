// 4.4 TRANSFERRING OWNERSHIP OF RETURN VALUES
...
//     let s3 = takes_and_gives_back(s2); // s2 is moved into takes_and_gives back, which also moves its
...
// 4.5 RETURNING OWNERSHIP OF PARAMETERS 
// TUPLE BASED VERSION
// fn main() {
